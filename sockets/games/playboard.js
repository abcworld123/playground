  ...
  nsp.on('connection', (socket) => {
    ...
    socket.on('connection', (roomNum) => {
      if (!playBoard.has(roomNum)) {
        ...
        playBoard.set(roomNum, userInfo);
        setInterval(calPlay.bind(this, roomNum), 12 );
      }
    });
    ...
    function calPlay(roomNum) {
      ...
      if ((userInfo.play_ball_x >= 100 || userInfo.play_ball_x <= 0) && userInfo.play_ball_pause < 1 ) {
      ...
      nsp.to(userInfo.play1).emit('playboard', userInfo.player1_x, userInfo.player1_y, userInfo.player2_x, userInfo.player2_y, userInfo.play_ball_x, userInfo.play_ball_y);
      nsp.to(userInfo.play2).emit('playboard', userInfo.player1_x, userInfo.player1_y, userInfo.player2_x, userInfo.player2_y, userInfo.play_ball_x, userInfo.play_ball_y);
    }
